...
public class ExperiencePostActivity extends AppCompatActivity {
    ...
    public void comment(){
        if(memberData.getCoinCount() > 0){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ExperiencePostActivity.this);
            ...
            builder.setPositiveButton("예",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("fromWhere","ExperiencePostActivity");
                            intent.putExtra("postNumber",postNumber);
                            startActivityForResult(intent,COINSTORE_CODE);
                        }
                    });
