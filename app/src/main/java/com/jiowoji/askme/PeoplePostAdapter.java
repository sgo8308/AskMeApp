...
//            likeCount.setText(Integer.toString(memberData.getLikeCount()));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(PeopleCommentData peopleCommentData){
            ...
            String nickName = memberDatas.get(peopleCommentData.getId()).getNickName();
            String job1 = memberDatas.get(peopleCommentData.getId()).getJob();
            //댓글 작성자
            ...
            String nickNamePosted = memberDatas.get(peopleCommentData.getOwnerId()).getNickName();
            String job1Posted = memberDatas.get(peopleCommentData.getOwnerId()).getJob();
