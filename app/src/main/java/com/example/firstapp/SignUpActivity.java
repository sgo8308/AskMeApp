...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FrameLayout frameLayout = findViewById(R.id.frameLayout_certification);
            ...
            public void onClick(View v) {
                if(editText_certificatonNumber.getText().toString().length() == 6){
                    if(editText_certificatonNumber.getText().toString().equals(certificationNumber)){
                        ...
                        certification_button.setVisibility(GONE);
                        frameLayout.setVisibility(GONE);
        ...
        button_signUp.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(id.getText().toString().equals("1")){
                    ...
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); //다시 로그인 화면으로 돌아갔을 때 oncreate하여 셰어드를 초기화시키고 로그인 액티비티만 남기려고 finish를 안 씀 근데 클리어 탑 아닌 거 같음
